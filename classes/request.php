...
// Imports
include 'classes/form-model.php';
...
// hdn_id_cidade = $_POST['$ID_CIDADE'];
// Variables

// Form 1
$CORRESPONDENCIA = 0;
$frm_checkRegin = $_POST['sl_checkRegin'];
$PROTOCOLO_REGIN = $_POST['sl_protRegin'];
$frm_radioMei = $_POST['sl_radioMei'];
$NR_FUNC_MEI = $_POST['sl_qtdFunc'];
$noEdif = $_POST['sl_noEdif'];
$noEdif2 = $_POST['sl_noEdif2'];
$tower = $_POST['sl_tower'];
$ativCom = $_POST['sl_ativCom'];
$sl_agrop = $_POST['sl_agrop'];
$NR_CNPJ_EMPRESA = $_POST['sl_natId'];
$NM_FANTASIA = $_POST['sl_nameFant'];
$NR_FONE_PROPRIETARIO = $_POST['sl_phone'];
$NM_RAZAO_SOCIAL = $_POST['sl_corporateName'];
$NM_CONTATO = $_POST['sl_nameCont'];
$DE_EMAIL_PROPRIETARIO = $_POST['sl_email'];
$NM_PROPRIETARIO = $_POST['sl_name'];
$NR_FONE_EMPRESA = $_POST['sl_phoneAdm'];
$NR_CNPJ_CPF_PROPRIETARIO = $_POST['sl_natId2'];
$DE_EMAIL_EMPRESA = $_POST['sl_emailAdm'];
$NM_EDIFICACOES = $_POST['sl_name2'];
$NM_FANTASIA_EMPRESA = $_POST['sl_fant2'];
$ID_EDIFICACAO = $_POST['sl_re'];
$NR_CEP = $_POST['sl_cep'];
$ID_TP_LOGRADOURO = $_POST['sl_tipLog'];
$NM_LOGRADOURO = $_POST['sl_log'];
$NR_EDIFICACOES = $_POST['sl_num'];
$NM_COMPLEMENTO = $_POST['sl_compl'];
// $ID_CIDADE = $_POST['$ID_CIDADE'];
$ID_CIDADE = $_POST['sl_city'];
$NM_BAIRRO = $_POST['sl_block'];
$endRes = $_POST['sl_endRes'];
$endEsc = $_POST['sl_endEsc'];
$ID_OCUPACAO = $_POST['sl_occupation'];
$frm_description = $_POST['sl_description'];
$ID_SITUACAO = $_POST['sl_situation'];
$NR_PAVIMENTOS = $_POST['sl_floors'];
$ID_ESCADA = $_POST['sl_stairs'];
$LOTACAO_MAXIMA = $_POST['sl_capacity'];
// $ID_TP_CONSTRUCAO = $_POST['sl_type'];
$CH_TP_FUNCIONAMENTO = $_POST['sl_type'];
$NR_BLOCOS = $_POST['sl_nbBlock'];
$mist = $_POST['sl_mist'];
$USA_GAS = $_POST['sl_glp'];
$QTD_GAS = $_POST['sl_quantGlp'];
$USA_COMBUSTIVEL = $_POST['sl_dep'];
$QTD_COMBUSTIVEL = $_POST['sl_depLiq'];
$EXPLOSIVOS = $_POST['sl_exp'];
$frm_store = $_POST['sl_store'];
$NR_PESSOAS = $_POST['sl_reunion'];
$frm_edification = $_POST['sl_edification'];
$VL_AREA_PARCIAL = $_POST['sl_edifArea'];
$VL_AREA_CONSTRUIDA = $_POST['sl_area'];
$frm_checkRead = $_POST['sl_checkRead'];
$ID_TP_VISTORIA = $_POST['sl_checkVist'];
if($frm_radioMei == "sim")
{
    $ID_TP_MEI = 1;
}
...
if(
    $NR_CNPJ_EMPRESA == '' ||
    $NM_FANTASIA == '' ||
    $NR_FONE_PROPRIETARIO == '' ||
    $NM_RAZAO_SOCIAL == '' ||
    $NM_CONTATO == '' ||
    $DE_EMAIL_PROPRIETARIO == '' ||
    $NM_PROPRIETARIO == '' ||
    $NR_FONE_EMPRESA == '' ||
    $NR_CNPJ_CPF_PROPRIETARIO == '' ||
    $DE_EMAIL_EMPRESA == '' ||
    $NM_EDIFICACOES == '' ||
    $NR_CEP == '' ||
    $ID_TP_LOGRADOURO == '' ||
    ...
    echo 'Regin:' . $PROTOCOLO_REGIN . '<br>';
    echo 'MEI?' . $ID_TP_MEI . '<br>';
    echo 'Funcionários:' . $NR_FUNC_MEI . '<br>';
    echo 'Edif:' . $noEdif . '<br>';
    echo 'Edif2:' . $noEdif2 . '<br>';
    echo 'tower:' . $tower . '<br>';
    echo 'ativCom:' . $ativCom . '<br>';
    echo 'sl_agrop:' . $sl_agrop . '<br>';
    echo 'CPF/CNPJ:' . $NR_CNPJ_EMPRESA . '<br>';
    echo 'Nome Fantasia:' . $NM_FANTASIA . '<br>';
    echo 'Telefone:' . $NR_FONE_PROPRIETARIO . '<br>';
    echo 'Razão Social:' . $NM_RAZAO_SOCIAL . '<br>';
    echo 'Contato:' . $NM_CONTATO . '<br>';
    echo 'E-mail:' . $DE_EMAIL_PROPRIETARIO . '<br>';
    echo 'Nome:' . $NM_PROPRIETARIO . '<br>';
    echo 'Telefone 2:' . $NR_FONE_EMPRESA . '<br>';
    echo 'CPF/CNPJ:' . $NR_CNPJ_CPF_PROPRIETARIO . '<br>';
    echo 'E-mail 2:' . $DE_EMAIL_EMPRESA . '<br>';
    echo 'Nome 2:' . $NM_EDIFICACOES . '<br>';
    echo 'Nome Fantasia:' . $NM_FANTASIA_EMPRESA . '<br>';
    echo 'RE:' . $ID_EDIFICACAO . '<br>';
    echo 'CEP:' . $NR_CEP . '<br>';
    echo 'Tipo de Logradouro:' . $ID_TP_LOGRADOURO . '<br>';
    echo 'Logradouro:' . $NM_LOGRADOURO . '<br>';
    echo 'Número:' . $NR_EDIFICACOES . '<br>';
    echo 'Complemento:' . $NM_COMPLEMENTO . '<br>';
    echo 'Cidade:' . $ID_CIDADE . '<br>';
    echo 'Bairro:' . $NM_BAIRRO . '<br>';
    echo 'endRes:' . $endRes . '<br>';
    echo 'endEsc:' . $endEsc . '<br>';
    echo 'Ocupação:' . $ID_OCUPACAO . '<br>';
    echo 'Descrição:' . $frm_description . '<br>';
    echo 'Situação:' . $ID_SITUACAO . '<br>';
    echo 'Pavimentos:' . $NR_PAVIMENTOS . '<br>';
    echo 'Tipo de escadas:' . $ID_ESCADA . '<br>';
    echo 'Capacidade:' . $LOTACAO_MAXIMA . '<br>';
    echo 'Tipo:' . $CH_TP_FUNCIONAMENTO . '<br>';
    echo 'Blocos:' . $NR_BLOCOS . '<br>';
    echo 'mist:' . $mist . '<br>';
    echo 'GLP?' . $USA_GAS . '<br>';
    echo 'Quant. GLP:' . $QTD_GAS . '<br>';
    echo 'Depósito?' . $USA_COMBUSTIVEL . '<br>';
    echo 'Quant. Dep.?' . $QTD_COMBUSTIVEL . '<br>';
    echo 'Fabrica explosivos?' . $EXPLOSIVOS . '<br>';
    echo 'Armazena em área externa?' . $frm_store . '<br>';
    echo 'Reunião?' . $NR_PESSOAS . '<br>';
    echo 'Edificação?' . $frm_edification . '<br>';
    echo 'Área de edificação?' . $VL_AREA_PARCIAL . '<br>';
    echo 'Área:' . $VL_AREA_CONSTRUIDA . '<br>';
    echo 'Lido:' . $frm_checkRead . '<br';
    // Tests
}
// Form 1
...
"WHERE ".
    ...
    TBL_SOL_FUNC.".NR_CNPJ_EMPRESA = ".$NR_CNPJ_EMPRESA." AND ".
...
echo ".$sql.";
if((!$encontrouSolicitacao) && $_POST['validacao'] == "1") {
...
// ===================================================================================
            ...
            if ($aprova_auto) {
                ...
                if($tp_vistoria === NULL) {
                    ...
                    $ID_TP_PESSOA                    = "'S'";
                    $NM_RAZAO_SOCIAL_FONETICA        = $NM_RAZAO_SOCIAL;
                    $NM_CONTATO_FONETICO            = $NM_CONTATO;
                    $NM_FANTASIA_FONETICO_EMPRESA    = $NM_FANTASIA_EMPRESA;
                    $NM_FANTASIA_FONETICA            = $NM_FANTASIA_EMPRESA;
